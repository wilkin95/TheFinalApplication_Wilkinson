   ...
   public static class ConsoleUtil
    {
        ...
        public static string CenterPrompt(string text, int windowWidth)
        {
            int leftPadding = (windowWidth - text.Length) / 2 + text.Length;
            return text.PadLeft(leftPadding).PadRight(75);
        }
        /// <summary>
        ...
        public static string ValidateStringResponse(string promptMessage, string userResponse)
        {
            ...
            while (userResponse == "")
            {
                ...
                ConsoleView.DisplayMessage("It appears you did not enter anything.");

                ConsoleView.DisplayMessage("");
                ConsoleView.DisplayMessage(promptMessage);
        ...
        public static int ValidateSongIDIntegerResponse(List<Song> songs, string promptMessage, string userResponse)
        {
            int userResponseInteger = 0;
